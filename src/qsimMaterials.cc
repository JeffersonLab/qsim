 ...
 */
qsimMaterials* qsimMaterials::instance=0;  
/**
 * Instance of the Singleton Class
 *
 * @return the instance of the Singleton Materials
 */
qsimMaterials* qsimMaterials::GetInstance(){
	if (instance ==0){
		instance = new qsimMaterials();
	}
	return instance;
}
...
G4Material* qsimMaterials::GetMaterial(const G4String material){
 ...
 */
void qsimMaterials::CreateMaterials(){
	G4double density;
...
void qsimMaterials::SetOpticalPropertiesPMMA(){
 ...
 */
void qsimMaterials::SetOpticalPropertiesEJ426(){
	// Refrative Index
 ...
 */
void qsimMaterials::SetOpticalPropertiesTeflon(){
 ...
 */
void qsimMaterials::SetOpticalPropertiesGS20(){
 ...
 */
void qsimMaterials:: SetOpticalPropertiesBK7(){
	// Index of Reflection (146 nm to 1570 nm)
	const G4int nRINDEX = 13;
	G4double photonEnergyRINDEX[nRINDEX] = 
	{8.5506*eV,4.7232*eV,3.2627*eV,2.4921*eV,2.0160*eV,
 ...
 */
void qsimMaterials::SetOpticalPropertiesSilicone(){
 ...
 * These values are from the GEANT4 WLS example
 */
void qsimMaterials:: SetOpticalPropertiesAir(){
	const G4int nEntries = 50;
 ...
 *
 */
void qsimMaterials::SetOpticalPropertiesPS(){
	//--------------------------------------------------
	//  Polystyrene
	//--------------------------------------------------
